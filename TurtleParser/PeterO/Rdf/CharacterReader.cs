...
if (str.Length - offset < length) {
  throw new ArgumentException("str's length minus " + offset + " (" +
    ...
    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.IO.Stream)"]/*'/>
    public CharacterReader(Stream stream) : this(stream, 0, false) {
    }

    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.IO.Stream,System.Int32,System.Boolean)"]/*'/>
    public CharacterReader(Stream stream, int mode, bool errorThrow) :
      this(stream, mode, errorThrow, false) {
    }

    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.IO.Stream,System.Int32)"]/*'/>
    public CharacterReader(Stream stream, int mode) :
      this(stream, mode, false, false) {
    }

    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.IO.Stream,System.Int32,System.Boolean,System.Boolean)"]/*'/>
    public CharacterReader(
  Stream stream,
  int mode,
  bool errorThrow,
