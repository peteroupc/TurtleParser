...
import com.upokecenter.text.*;
    ...
    // path='docs/doc[@name="T:PeterO.Rdf.CharacterReader"]/*'/>
  final class CharacterReader implements ICharacterInput {
    ...
    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.String)"]/*'/>
    public CharacterReader(String str) {
 this(str, false, false);
    }

    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.String,System.Boolean)"]/*'/>
    public CharacterReader(String str, boolean skipByteOrderMark) {
 this(str, skipByteOrderMark, false);
    }

    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.String,System.Boolean,System.Boolean)"]/*'/>
  ...
  boolean errorThrow) {
    ...
    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.String,System.Int32,System.Int32)"]/*'/>
    public CharacterReader(String str, int offset, int length) {
 this(str, offset, length, false, false);
    }

    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.String,System.Int32,System.Int32,System.Boolean,System.Boolean)"]/*'/>
    public CharacterReader(
  String str,
  int offset,
  int length,
...
if (str.length() - offset < length) {
  throw new IllegalArgumentException("str's length minus " + offset + " (" +
    ...
    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.IO.InputStream)"]/*'/>
    public CharacterReader(InputStream stream) {
 this(stream, 0, false);
    }

    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.IO.InputStream,System.Int32,System.Boolean)"]/*'/>
    public CharacterReader(InputStream stream, int mode, boolean errorThrow) {
 this(stream, mode, errorThrow, false);
    }

    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.IO.InputStream,System.Int32)"]/*'/>
    public CharacterReader(InputStream stream, int mode) {
 this(stream, mode, false, false);
    }

    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.#ctor(System.IO.InputStream,System.Int32,System.Boolean,System.Boolean)"]/*'/>
    public CharacterReader(
  InputStream stream,
  int mode,
  boolean errorThrow,
  boolean dontSkipUtf8Bom) {
    ...
    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.Read(System.Int32[],System.Int32,System.Int32)"]/*'/>
    ...
    // <include file='../../docs.xml'
    // path='docs/doc[@name="M:PeterO.Rdf.CharacterReader.ReadChar"]/*'/>
    public int ReadChar() {
      if (this.reader != null) {
