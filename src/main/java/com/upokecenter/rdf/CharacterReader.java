...
import com.upokecenter.text.*;
  ...
  final class CharacterReader implements ICharacterInput {
    ...
    // <see cref='T:PeterO.Rdf.CharacterReader'/> class using a Unicode
    // 16-bit String; if the String begins with a byte-order mark
    // (U+FEFF), it won't be skipped, and any unpaired surrogate code
    // points (U + D800 to U + DFFF) in the String are replaced with
 ...
 this(str, false, false);
    ...
    // <summary>Initializes a new instance of the
    // <see cref='T:PeterO.Rdf.CharacterReader'/> class using a Unicode
    // 16-bit String; any unpaired surrogate code points (U + D800 to
 ...
 this(str, skipByteOrderMark, false);
    ...
    // <summary>Initializes a new instance of the
    // <see cref='T:PeterO.Rdf.CharacterReader'/> class using a Unicode
    // 16-bit String.</summary>
    // <param name='str'>The String to read.</param>
    // <param name='skipByteOrderMark'>If true and the String begins with
    // a byte-order mark (U + FEFF), will skip that code point as it reads
    // the String.</param>
    // <param name='errorThrow'>If true, will throw an exception if
    // unpaired surrogate code points (U + D800 to U + DFFF) are found in the
    // String. If false, replaces those byte sequences with replacement
    // characters (U + FFFD) as the stream is read.</param>
    // <exception cref='T:java.lang.NullPointerException'>The parameter
    // <paramref name='str'/> is null.</exception>
  ...
  boolean errorThrow) {
    ...
    // <summary>Initializes a new instance of the
    // <see cref='T:PeterO.Rdf.CharacterReader'/> class.</summary>
...
if (str.length() - offset < length) {
  throw new IllegalArgumentException("str's length minus " + offset + " (" +
    ...
    // <summary>Initializes a new instance of the
    // <see cref='T:PeterO.Rdf.CharacterReader'/> class; will read the
 ...
 this(stream, 0, false);
    ...
    // <summary>Initializes a new instance of the
    // <see cref='T:PeterO.Rdf.CharacterReader'/> class; will skip the
    // byte-order mark (U + FEFF) if it appears first in the
    // stream.</summary>
    ...
    // non-zero basic code point (NZB, U + 0001 to U + 007F) before reading
 ...
 this(stream, mode, false, false);
  ...
  boolean dontSkipUtf8Bom) {
    ...
    // <exception cref='T:java.lang.IllegalArgumentException'>Either <paramref
